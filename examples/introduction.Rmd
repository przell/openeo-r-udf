...
result_with_rct = jsonlite::fromJSON(run_udf(data = "raster_collection_tile.json",code = script,port=port),simplifyVector = TRUE)
result_with_cube = jsonlite::fromJSON(run_udf(data = "hypercube.json",code = script,port=port),simplifyVector = TRUE)
```
